...
This module is called by ``backend.services.tool_registry`` which aggregates MCP
callables together with HTTP and agent tool callables into a single registry dict.
See ``backend/services/tool_registry.py`` for the entry point used by all nodes.
"""
